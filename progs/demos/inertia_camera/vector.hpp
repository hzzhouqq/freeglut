...
#ifndef M_PI
#define M_PI       3.14159265358979323846f         // The value of PI
#endif
...
public:
	...
	Vector3f Rotate( Vector3f& axis, float angleRAD ) {
		...
		float radian = angleRAD * M_PI/180.0f;
		return ((iv * cosf(radian) +  jv * sinf(radian)) * this -> Length());
	}
