...
void PhysicsStep()
{
	...
	float pfHorizontalStabRelativeWind[] = {pfRelativeWind[0],
											pfRelativeWind[1],
											pfRelativeWind[2]};
	pfHorizontalStabRelativeWind[0] += g_fDXStabilizerWingCenterOfLift * g_fPitchSpeed * sinf(g_fOrientation*g_fDegToRad);
	pfHorizontalStabRelativeWind[2] += g_fDXStabilizerWingCenterOfLift * g_fPitchSpeed * cosf(g_fOrientation*g_fDegToRad);

	float fX = g_fDXStabilizerWingCenterOfLift * g_fPitchSpeed * sinf(g_fOrientation*g_fDegToRad);
	float fY = g_fDXStabilizerWingCenterOfLift * g_fPitchSpeed * cosf(g_fOrientation*g_fDegToRad);
...
//	fCL_hs *= 0.95f;
	...
	float pfMainWingRelativeWind[] = {pfRelativeWind[0],
											pfRelativeWind[1],
											pfRelativeWind[2]};
	pfMainWingRelativeWind[0] += g_fDXMainWingCenterOfLift * g_fPitchSpeed * sinf(g_fOrientation*g_fDegToRad);
	pfMainWingRelativeWind[2] += g_fDXMainWingCenterOfLift * g_fPitchSpeed * cosf(g_fOrientation*g_fDegToRad);

	fX = g_fDXMainWingCenterOfLift * g_fPitchSpeed * sinf(g_fOrientation*g_fDegToRad);
	fY = g_fDXMainWingCenterOfLift * g_fPitchSpeed * cosf(g_fOrientation*g_fDegToRad);
...
// The first mesh is the horizontal stabilizer (the forward wing)
	...
	float fDXTip = g_fStabilizerSemiSpan * tanf(g_fStabilizerLeadingEdgeSweep);
...
// second wing is the larger, rear wing
	...
	fDXTip = g_fMainWingSemiSpan * tanf(g_fMainWingLeadingEdgeSweep);
	...
	float fWingIncidence, float *pfCL, float *pfCD)
{
	...
	float fWingCenterline[] = {cosf(fWingAbsoluteIncidence),
								-sinf(fWingAbsoluteIncidence)};
